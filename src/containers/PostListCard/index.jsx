...
const fakeData = [
  ...
  },
  {
    ...
    title:
      '兩岸開戰台北101將化為灰燼！？ 24劇本美日台慘勝「南台灣登陸戰」能源是死穴！【關鍵時刻】2023',
    pt: '主文',
    src: 'YOUTUBE',
    ...
    author: '關鍵時刻',
    summary:
      '美國24次兵推21次從南部登陸！？ 解放軍「一路向北」台灣要死守70天等待馳援！？\n解放軍登陸戰拚首日8千人上岸！？ CSIS：中國空降部隊太脆弱、只能靠海軍登陸！\n美國沉2航母換中國海軍全滅！？ 美',
  ...
  },
  {
    ...
    title:
      '【精選】「南台灣成破口」解放軍登陸戰首日拚8千人上岸！？美兵推結果慘勝「基地」成扭轉台海戰局關鍵！【',
    pt: '主文',
    src: 'YOUTUBE',
  ...
  },
  {
    ...
    title:
      '閒暇之餘時常會在住家周邊的街道散步，因附近新蓋建築多，人行道較為平整，但是其他市區街道的狀況卻參差不',
    pt: '主文',
    src: 'FACEBOOK',
  ...
  },
  {
    ...
    title:
      '【頭條開講】秦剛雷霆怒!嚇到尹錫悅急令內閣快解釋!口岸簽證也不通!日韓嚇到嘴皮放軟"遺憾"?英義日大',
    pt: '主文',
    src: 'YOUTUBE',
  ...
  },
  {
    ...
    title:
      '中國兩會後共軍對美台「極盡挑釁」！ 逼近台灣西北空域天弓、愛國者警鈴大作！？【關鍵時刻】202301',
    pt: '主文',
    src: 'YOUTUBE',
...
const columns = [
  ...
  },
  {
    ...
    renderCell: (index) => (
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <CustomTypography>{index.value}</CustomTypography>
        </Box>
      </NoMaxWidthTooltip>
    ),
  },
  {
    ...
    width: 100,
    sortable: false,
    renderCell: (index) => <CustomTypography>{index.value}</CustomTypography>,
  },
  {
    field: 'time',
    headerName: '時間',
...
function PostListCard({
  ...
  const newColumns = withLikeShare
    ? [...columns.slice(0, 3), ...additionalColumn, ...columns.slice(3, 4)]
    : columns
